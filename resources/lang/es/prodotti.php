...
/**
 * Prodotti — stringhe del modulo (italiano canonico).
 *
 * Questo file viene generato in resources/lang/it/prodotti.php (+ copie
 * in en/fr/de/es da tradurre). NON lasciare stringhe hardcoded nelle View/Controller:
 * passa sempre da t('prodotti.<chiave>') con e() intorno per l'output HTML.
 *
 * Placeholder di interpolazione in stile :nome → t('prodotti.count_total', ['count' => $n]).
...
return [
    ...
    'new_page_title'  => 'Nuovo Prodotti',
    'edit_page_title' => 'Modifica Prodotti',
