...
<head>
    ...
    <title>404 — <?= e(t('errors.not_found.title')) ?></title>
    <?php
...
<body class="err-page-404">
    ...
    <div class="err-wrapper">
        <div class="err-card">
            ...
            <div class="err-icon-wrap err-icon-wrap-404">
                <i class="fa-solid fa-compass-slash"></i>
            </div>

            <div class="err-code err-code-404">404</div>
            <div class="err-title"><?= e(t('errors.not_found.title')) ?></div>
            <p class="err-message">
                <?= t('errors.not_found.message') ?>
            </p>

            <a href="<?= $errAssetBase ?>/" class="err-btn err-btn-404">
                <i class="fa-solid fa-house me-2"></i><?= e(t('errors.back_home')) ?>
            </a>

            <p class="err-message">
                <?= e(t('errors.is_error_q')) ?>
                <a href="<?= $errAssetBase ?>/feedback/new?from=404&amp;url=<?= rawurlencode($_SERVER['REQUEST_URI'] ?? '') ?>"><?= e(t('errors.report_problem')) ?></a>
            </p>
